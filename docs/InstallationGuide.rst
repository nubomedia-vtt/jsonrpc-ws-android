...
This documents provides information how to compile the jsonrpc-ws-android library from the sources for your project.
...
.. code:: bash
    ...
    git clone https://github.com/nubomedia-vtt/jsonrpc-ws-android.git
